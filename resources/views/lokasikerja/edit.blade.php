...
@section('content')
    <div>
        ...
        <form action="{{ route('lokasikerjas.update', ['lokasikerja' => $lokasi_kerja->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row">
                <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control @error('nama') is-invalid @enderror" type="text"
                                        name="nama" id="nama" value="{{ $errors->any() ? old('nama') : $lokasi_kerja->nama }}"
