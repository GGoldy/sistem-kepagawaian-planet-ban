                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control @error('nama') is-invalid @enderror" type="text"
                                        name="nama" id="nama"
                                        value="{{ $errors->any() ? old('nama') : $lokasi_kerja->nama }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control @error('latitude') is-invalid @enderror" type="number"
                                        ...
                                        value="{{ $errors->any() ? old('latitude') : $lokasi_kerja->latitude }}" placeholder="Latitude (Max 8 decimal places)">
                                    @error('latitude')
                                        <div class="text-danger"><small>{{ $message }}</small></div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control @error('longitude') is-invalid @enderror" type="number"
                                        ...
                                        value="{{ $errors->any() ? old('longitude') : $lokasi_kerja->longitude }}" placeholder="Longitude (Max 8 decimal places)">
                                    @error('longitude')
                                        <div class="text-danger"><small>{{ $message }}</small></div>
                                    @enderror
                                </div>
